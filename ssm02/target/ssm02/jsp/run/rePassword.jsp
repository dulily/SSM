    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <div class="content-item">
                ...
                <form id="updatePwd" class="form-horizontal" role="form" action="${ctx}/run/updateRunPwd" method="post">
                    <div class="form-group">
                        <label for="password" class="col-sm-1 control-label">原密码</label>
                        <div class="col-sm-6">
                            <input type="hidden" name="username" id="username" value="${runSession.username}">
