...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <h2 style="margin: 20px 0">发布新闻</h2>
            <p style="margin: 20px 0;">
                <a href="${ctx}/news/queryAll" class="layui-btn layui-btn-warm layui-anim layui-anim-scale">☇ 新闻列表</a>
            </p>
            <div class="layui-row">
                <div class="layui-col-xs6 layui-col-sm6 layui-col-md6">
                    <form class="form-horizontal" role="form" method="post" action="${ctx}/news/insertOne" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="3" placeholder="请输入新闻内容" name="content"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <div class="inputFileWrapper">
                                    <label for="inputFile">
                                        ...
                                        <span class="custorm-style">
                                            ...
                                            <span class="right-text" id="rightText">未选择任何文件</span>
                                        </span>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="请输入新闻作者" name="author">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">发布人</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="请输入发布人" name="username">
                            </div>
                        </div>
